...
print(decimal)
print(bin(decimal))
# # explanation : -1 because we start with the number 0
# so we need to take off a value, the value 0.
# 2 because bit haS ONLY 2 values, if this was asked in Decimal then it would be 9
...
# '&' and 'and' is the same command 'and bitwise operator' ?
...
print(num << shift_amount2)  # shift left by 2 bits   # this is calculated in Binary
...
print(num * 2**shift_amount2)  # this is calculated in decimal
