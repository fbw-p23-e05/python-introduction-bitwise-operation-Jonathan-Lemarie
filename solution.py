...
d = c ^ __
print(bin(c), '^',bin(__), '= ', bin(d)) # 0b11 ^ 0b10 = 0b1
...
print(__ __ __)  # shift left by 1 bit
print(__ __ __)  # shift left by 2 bits
print(__ __ __)  # shift left by 3 bits
print(__ __ __)  # shift left by 4 bits

print(bin(__ __ __)) # shift left by 1 bit
print(bin(__ __ __)) # shift left by 2 bits
print(bin(__ __ __)) # shift left by 3 bits
print(bin(__ __ __)) # shift left by 4 bits
